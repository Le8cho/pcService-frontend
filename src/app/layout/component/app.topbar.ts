...
@Component({
    ...
    <div class="layout-topbar-actions">
        ...
        <button type="button" class="layout-topbar-action" style="margin-left: 1rem;">
            <i class="pi pi-user"></i>
            <span style="margin-left: 0.5rem; font-weight: bold; color: #333;">
                {{ authService.isLoggedIn() ? 'Autenticado' : 'No autenticado' }}
            </span>
            <i *ngIf="authService.isLoggedIn()" class="pi pi-check" style="color: green; margin-left: 0.5rem;"></i>
            <i *ngIf="!authService.isLoggedIn()" class="pi pi-exclamation-triangle" style="color: orange; margin-left: 0.5rem;"></i>
        </button>

        <button *ngIf="authService.isLoggedIn()" type="button" class="layout-topbar-action" style="margin-left: 0.5rem; background: #f44336; color: white; border-radius: 20px; padding: 0 1rem;" (click)="logout()">
